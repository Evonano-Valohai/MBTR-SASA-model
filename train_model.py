...
def main():
    ...
    input_path_train = valohai.inputs('dataset_train').path()
    input_path_test = valohai.inputs('dataset_test').path()
    x_train, y_train =  mbtr_ds_generator(input_path_train)
    x_test, y_test = mbtr_ds_generator(input_path_test)
